...
//	Person p2("Carlos",33);
//	ASSERT_EQUAL(true, net1.removeVertex(p2));
//	ASSERT_EQUAL(6, net1.getNumVertex());
//	vector<Person> v1=net1.dfs();
...
//	Person pt;
//	int qt = net1.maxNewChildren(Person("Ana",19), pt);
...
////	s.push_back(CUTE(testDijkstraDistance));
////	s.push_back(CUTE(testDijkstraDistancePeople));
//
